...
const demos = [
  ...
  { route: '/network-dashboard', title: 'Network Administration Dashboard', description: 'Network monitoring dashboard with traffic analytics and device management.', category: 'Dashboards' },
  {
