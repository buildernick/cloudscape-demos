...
export default function PupBotChat({ isOpen, onToggle }: PupBotChatProps) {
  ...
  const rocketIcon = (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M14.77 1.28a6.77 6.77 0 0 1 8.95 8.95l-5.66 5.65a5.43 5.43 0 0 1-.77.7L12 22l-5.29-5.58a5.43 5.43 0 0 1-.77-.7L.28 10.07A6.77 6.77 0 0 1 9.23 1.28l2.77 2.77 2.77-2.77zm-3.84 6.13a1.93 1.93 0 1 0 2.73 2.73 1.93 1.93 0 0 0-2.73-2.73z"
        fill="#D73502"
      />
    </svg>
  );
  ...
  if (!isOpen) {
    return (
      <div className="pupbot-chat-trigger">
        <Button variant="primary" onClick={onToggle} ariaLabel="Open PupBot chat">
          💬
        </Button>
      </div>
    );
      ...
      <div className="pupbot-chat-window">
        ...
        <div className="pupbot-chat-header">
          ...
          <div className="pupbot-chat-actions">
            <button className="pupbot-header-button" onClick={onToggle} aria-label="Minimize chat">
              <svg width="10" height="6" viewBox="0 0 10 6" fill="none">
                <path
                  d="M1.70711 0.292893C1.31658 -0.0976311 0.683417 -0.0976311 0.292893 0.292893C-0.0976305 0.683418 -0.0976305 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292893C9.31658 -0.0976311 8.68342 -0.0976311 8.29289 0.292893L5 3.58579L1.70711 0.292893Z"
                  fill="white"
                />
              </svg>
            </button>
            <button className="pupbot-header-button" aria-label="More options">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M20 10C21.1046 10 22 10.8954 22 12C22 13.1046 21.1046 14 20 14C18.8954 14 18 13.1046 18 12C18 10.8954 18.8954 10 20 10ZM12 10C13.1046 10 14 10.8954 14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8954 10.8954 10 12 10ZM4 10C5.10457 10 6 10.8954 6 12C6 13.1046 5.10457 14 4 14C2.89543 14 2 13.1046 2 12C2 10.8954 2.89543 10 4 10Z"
                  fill="white"
                />
              </svg>
            </button>
        ...
        <div className="pupbot-chat-content">
          {messages.length === 1 && (
            <>
              ...
              <div className="pupbot-intro">
                <div className="pupbot-avatar-large">{rocketIcon}</div>
                ...
                <Button variant="normal">Explore my skills</Button>
              </div>
          ...
          <div className="pupbot-messages">
            {messages.map(msg => (
              <div
                key={msg.id}
                className={`pupbot-message ${msg.sender === 'user' ? 'pupbot-message-outgoing' : 'pupbot-message-incoming'}`}
              >
                <div className="pupbot-message-content">
                  {msg.sender === 'bot' && <div className="pupbot-avatar-small">{rocketIcon}</div>}
                  ...
                  <div className="pupbot-message-body">
                    ...
                    <div
                      className={`pupbot-message-bubble ${msg.sender === 'user' ? 'pupbot-message-bubble-user' : 'pupbot-message-bubble-bot'}`}
                    >
                      {msg.text.includes('7EE2411') ? (
                        <span>
                          Your shipment for <strong>7EE2411</strong> is scheduled to arrive{' '}
                          <strong>June 4, 2051</strong> at <strong>10:36 PM</strong>.
                        </span>
                      ) : (
                        msg.text
                      )}
          ...
          <div className="pupbot-input-area">
            <div className="pupbot-textarea-container">
              <textarea
                ...
                maxLength={200}
              />
              <div className="pupbot-input-help">Press SHIFT + ENTER to insert a new line.</div>
              <div className="pupbot-char-count">{message.length}/200 characters</div>
            </div>
            ...
            <div className="pupbot-input-actions">
              ...
              <button className="pupbot-send-button">
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path
                    d="M15.45 7.11001L1.45001 0.110009C0.640006 -0.289991 -0.249994 0.490009 0.0600063 1.34001L1.88001 6.34001C2.02001 6.74001 2.40001 7.00001 2.82001 7.00001H8.02001C8.57001 7.00001 9.02001 7.45001 9.02001 8.00001C9.02001 8.55001 8.57001 9.00001 8.02001 9.00001H2.82001C2.40001 9.00001 2.02001 9.26001 1.88001 9.66001L0.0600063 14.66C-0.249994 15.51 0.640006 16.3 1.44001 15.89L15.44 8.89001C16.18 8.52001 16.18 7.47001 15.44 7.11001H15.45Z"
                    fill="#02080E"
                  />
                </svg>
              </button>
