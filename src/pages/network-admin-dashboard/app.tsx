...
export function App() {
  ...
  const filteredDevices = devicesData.filter(device =>
    Object.values(device).some(value => value?.toString().toLowerCase().includes(searchText.toLowerCase())),
  );
            ...
            {!dismissedWarning && (
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: 'white', fontSize: '14px', fontWeight: '400' }}>This is a warning message</span>
                </div>
                <button
                  type="button"
