      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1 }}>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_5172_4753)">
            ...
            <g mask="url(#mask0_5172_4753)">
              <path d="M8.125 5.64703V8.78428M8.125 10.6666H8.13128M14.3995 7.99997C14.3995 11.4653 11.5903 14.2745 8.125 14.2745C4.65969 14.2745 1.85049 11.4653 1.85049 7.99997C1.85049 4.53466 4.65969 1.72546 8.125 1.72546C11.5903 1.72546 14.3995 4.53466 14.3995 7.99997Z" stroke="#946C00" strokeWidth="1.88235" strokeLinecap="round" strokeLinejoin="round"/>
            </g>
          </g>
          <defs>
        ...
        <div style={{ flex: 1 }}>
          <SpaceBetween size="xs">
            <div>
              <span style={{ color: '#946C00', fontSize: '14px', fontFamily: 'Inter, -apple-system, Roboto, Helvetica, sans-serif', fontWeight: '400', lineHeight: '22px' }}>
            ...
            {showDetails && (
              <div style={{ color: '#946C00', fontSize: '14px', lineHeight: '22px', fontFamily: 'Inter, -apple-system, Roboto, Helvetica, sans-serif' }}>
